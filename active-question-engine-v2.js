(() => {
  ...
  load('VERIFIED_Q_V3_EXTRA','data/verified-question-bank-v3-extra60.js','1000');
  load('VERIFIED_Q_V4_EXTRA','data/verified-question-bank-v4-extra100.js','1000');
  load('VERIFIED_Q_V5_EXTRA','data/verified-question-bank-v5-extra300.js','1000');
  load('VERIFIED_Q_V6_A','data/verified-question-bank-v6-a100.js','1000');
  load('VERIFIED_Q_V6_B','data/verified-question-bank-v6-b100.js','1000');
  load('VERIFIED_Q_V6_C','data/verified-question-bank-v6-c100.js','1000');
  load('VERIFIED_Q_V6_D','data/verified-question-bank-v6-d100.js','1000');
  const base=Array.isArray(window.VERIFIED_Q_V1)?window.VERIFIED_Q_V1:[];
  const extra50=Array.isArray(window.VERIFIED_Q_V2_EXTRA)?window.VERIFIED_Q_V2_EXTRA:[];
  const extra60=Array.isArray(window.VERIFIED_Q_V3_EXTRA)?window.VERIFIED_Q_V3_EXTRA:[];
  const extra100=Array.isArray(window.VERIFIED_Q_V4_EXTRA)?window.VERIFIED_Q_V4_EXTRA:[];
  const extra300=Array.isArray(window.VERIFIED_Q_V5_EXTRA)?window.VERIFIED_Q_V5_EXTRA:[];
  const a=Array.isArray(window.VERIFIED_Q_V6_A)?window.VERIFIED_Q_V6_A:[];
  const b=Array.isArray(window.VERIFIED_Q_V6_B)?window.VERIFIED_Q_V6_B:[];
  const c=Array.isArray(window.VERIFIED_Q_V6_C)?window.VERIFIED_Q_V6_C:[];
  const d=Array.isArray(window.VERIFIED_Q_V6_D)?window.VERIFIED_Q_V6_D:[];
  const combined=[...base,...extra50,...extra60,...extra100,...extra300,...a,...b,...c,...d].map((q,i)=>({...q,sourceId:q.id,id:i}));
  ...
  if(base.length!==90||extra50.length!==50||extra60.length!==60||extra100.length!==100||extra300.length!==300||a.length!==100||b.length!==100||c.length!==100||d.length!==100||combined.length!==1000||bad.length||dup.length){throw new Error(`Aktif soru havuzu QA başarısız: total=${combined.length}, bad=${bad.map(q=>q.sourceId).join(',')}, dup=${dup.join(',')}`)}
  ...
  window.ARENA_ACTIVE_BANK_META={count:1000,optionCount:5,batches:[90,50,60,100,300,100,100,100,100],status:'active'};console.info('9. Sınıf Arena aktif soru motoru:',window.ARENA_ACTIVE_BANK_META);
})();